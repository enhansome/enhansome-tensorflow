...
* [Effective Tensorflow](https://github.com/vahidk/EffectiveTensorflow) ⭐ 8,581 | 🐛 1 | 📅 2020-10-22 - TensorFlow howtos and best practices. Covers the basics as well as advanced topics.
...
* [Classification on time series](https://github.com/guillaume-chevalier/LSTM-Human-Activity-Recognition) ⭐ 3,484 | 🐛 22 | 🌐 Jupyter Notebook | 📅 2022-11-06 - Recurrent Neural Network classification in TensorFlow with LSTM on cellphone sensor data
* [Sungjoon's TensorFlow-101](https://github.com/sjchoi86/Tensorflow-101) ⭐ 2,591 | 🐛 13 | 🌐 Jupyter Notebook | 📅 2020-03-23 - TensorFlow tutorials written in Python with Jupyter Notebook
...
* [Kubeflow](https://github.com/kubeflow/kubeflow) ⭐ 15,870 | 🐛 1 | 📅 2026-08-21 - Framework for easily using Tensorflow with Kubernetes.
* [Policy Gradient](https://github.com/zsdonghao/tensorlayer/blob/master/example/tutorial_atari_pong.py) ⭐ 7,379 | 🐛 36 | 🌐 Python | 📅 2023-02-18 - For Playing Atari Ping Pong
* [Deep Q-Network](https://github.com/zsdonghao/tensorlayer/blob/master/example/tutorial_frozenlake_dqn.py) ⭐ 7,379 | 🐛 36 | 🌐 Python | 📅 2023-02-18 - For Playing Frozen Lake Game
* [AC](https://github.com/zsdonghao/tensorlayer/blob/master/example/tutorial_cartpole_ac.py) ⭐ 7,379 | 🐛 36 | 🌐 Python | 📅 2023-02-18 - Actor Critic for Playing Discrete Action space Game (Cartpole)
* [A3C](https://github.com/zsdonghao/tensorlayer/blob/master/example/tutorial_bipedalwalker_a3c_continuous_action.py) ⭐ 7,379 | 🐛 36 | 🌐 Python | 📅 2023-02-18 - Asynchronous Advantage Actor Critic (A3C) for Continuous Action Space (Bipedal Walker)
* [YOLO TensorFlow ++](https://github.com/thtrieu/yolotf) ⭐ 6,138 | 🐛 641 | 🌐 Python | 📅 2023-10-23 - TensorFlow implementation of 'YOLO: Real-Time Object Detection', with training and an actual support for real-time running on mobile devices.
...
* [Wavenet](https://github.com/ibab/tensorflow-wavenet) ⭐ 5,426 | 🐛 176 | 🌐 Python | 📅 2023-07-12 - This is a TensorFlow implementation of the [WaveNet generative neural network architecture](https://deepmind.com/blog/wavenet-generative-model-raw-audio/) for audio generation.
...
* [Chatbot](https://github.com/Conchylicultor/DeepQA) ⭐ 2,909 | 🐛 93 | 🌐 Python | 📅 2022-12-30 - Implementation of ["A neural conversational model"](http://arxiv.org/abs/1506.05869)
* [DQN-tensorflow](https://github.com/devsisters/DQN-tensorflow) ⭐ 2,582 | 🐛 39 | 🌐 Python | 📅 2019-04-18 - TensorFlow implementation of DeepMind's 'Human-Level Control through Deep Reinforcement Learning' with OpenAI Gym by Devsisters.com
...
* [Seq2seq-Chatbot](https://github.com/tensorlayer/seq2seq-chatbot) ⭐ 838 | 🐛 28 | 🌐 Python | 📅 2021-10-05 - Chatbot in 200 lines of code
* [3D Convolutional Neural Networks in TensorFlow](https://github.com/astorfi/3D-convolutional-speaker-recognition) ⭐ 794 | 🐛 7 | 🌐 Python | 📅 2020-03-03 - Implementation of ["3D Convolutional Neural Networks for Speaker Verification application"](https://arxiv.org/abs/1705.09422) in TensorFlow by Torfi et al.
* [Character-Aware Neural Language Models](https://github.com/carpedm20/lstm-char-cnn-tensorflow) ⭐ 787 | 🐛 17 | 🌐 Python | 📅 2018-07-27 - TensorFlow implementation of [Character-Aware Neural Language Models](http://arxiv.org/abs/1508.06615)
...
* [GAN-CLS](https://github.com/zsdonghao/text-to-image) ⭐ 599 | 🐛 35 | 🌐 Python | 📅 2021-01-22 -Generative Adversarial Text to Image Synthesis
* [U-Net](https://github.com/zsdonghao/u-net-brain-tumor) ⭐ 536 | 🐛 42 | 🌐 Python | 📅 2019-08-17 - For Brain Tumor Segmentation
...
* [Neural Caption Generator with Attention](https://github.com/jazzsaxmafia/show_attend_and_tell.tensorflow) ⭐ 502 | 🐛 21 | 🌐 Jupyter Notebook | 📅 2019-10-23 - Implementation of ["Show, Attend and Tell"](http://arxiv.org/abs/1502.03044)
* [NeuralArt](https://github.com/ckmarkoh/neuralart_tensorflow) ⭐ 492 | 🐛 5 | 🌐 Python | 📅 2022-11-27 - Implementation of A Neural Algorithm of Artistic Style
* [TensorFlow White Paper Notes](https://github.com/samjabrahams/tensorflow-white-paper-notes) ⭐ 432 | 🐛 5 | 📅 2018-12-18 - Annotated notes and summaries of the TensorFlow white paper, along with SVG figures and links to documentation
* [Weakly\_detector](https://github.com/jazzsaxmafia/Weakly_detector) ⭐ 361 | 🐛 12 | 🌐 Jupyter Notebook | 📅 2017-07-29 - Implementation of ["Learning Deep Features for Discriminative Localization"](http://cnnlocalization.csail.mit.edu/)
* [GoogleNet Convolutional Neural Network Groups Movie Scenes By Setting](https://github.com/agermanidis/thingscoop) ⭐ 358 | 🐛 1 | 🌐 Python | 📅 2016-05-11 - Search, filter, and describe videos based on objects, places, and other things that appear in them
* [DCGAN](https://github.com/tensorlayer/dcgan) ⭐ 341 | 🐛 13 | 🌐 Python | 📅 2023-05-24 - Deep Convolutional Generative Adversarial Networks
* [End-To-End Memory Networks](https://github.com/domluna/memn2n) ⭐ 340 | 🐛 11 | 🌐 Python | 📅 2017-02-17 - Implementation of [End-To-End Memory Networks](http://arxiv.org/abs/1503.08895)
* [Tensorflow FastText](https://github.com/apcode/tensorflow_fasttext) ⭐ 302 | 🐛 9 | 🌐 Python | 📅 2018-07-18 - A simple embedding based text classifier inspired by Facebook's fastText.
* [HMM in TensorFlow](https://github.com/dwiel/tensorflow_hmm) ⭐ 285 | 🐛 4 | 🌐 Jupyter Notebook | 📅 2018-01-23 - Implementation of viterbi and forward/backward algorithms for HMM
* [Neural machine translation between the writings of Shakespeare and modern English using TensorFlow](https://github.com/tokestermw/tensorflow-shakespeare) ⭐ 249 | 🐛 4 | 🌐 Python | 📅 2022-12-11 - This performs a monolingual translation, going from modern English to Shakespeare and vice-versa.
* [DAGAN](https://github.com/nebulaV/DAGAN) ⭐ 180 | 🐛 7 | 🌐 Python | 📅 2019-07-11 - Fast Compressed Sensing MRI Reconstruction
* [Attentive Object Tracking](https://github.com/akosiorek/hart) ⭐ 147 | 🐛 11 | 🌐 Python | 📅 2018-08-20 - Implementation of ["Hierarchical Attentive Recurrent Tracking"](https://arxiv.org/abs/1706.09262)
* [Mnemonic Descent Method](https://github.com/trigeorgis/mdm) ⭐ 123 | 🐛 5 | 🌐 Jupyter Notebook | 📅 2022-05-21 - Tensorflow implementation of ["Mnemonic Descent Method: A recurrent process applied for end-to-end face alignment"](http://ibug.doc.ic.ac.uk/media/uploads/documents/trigeorgis2016mnemonic.pdf)
* [Ladder Network](https://github.com/divamgupta/ladder_network_keras) ⭐ 99 | 🐛 6 | 🌐 Python | 📅 2021-04-30 - Implementation of Ladder Network for Semi-Supervised Learning in Keras and Tensorflow
* [Improved CycleGAN](https://github.com/luoxier/CycleGAN_Tensorlayer) ⭐ 88 | 🐛 6 | 🌐 Python | 📅 2018-07-16 - Unpaired Image to Image Translation
* [Hierarchical Attention Networks](https://github.com/tqtg/hierarchical-attention-networks) ⭐ 87 | 🐛 1 | 🌐 Python | 📅 2019-05-28 - TensorFlow implementation of ["Hierarchical Attention Networks for Document Classification"](https://www.cs.cmu.edu/~hovy/papers/16HLT-hierarchical-attention-networks.pdf)
* [Unsupervised Object Counting](https://github.com/akosiorek/attend_infer_repeat) ⭐ 80 | 🐛 2 | 🌐 Python | 📅 2018-12-09 - Implementation of ["Attend, Infer, Repeat"](https://papers.nips.cc/paper/6230-attend-infer-repeat-fast-scene-understanding-with-generative-models)
* [im2im](https://github.com/zsdonghao/Unsup-Im2Im) ⭐ 72 | 🐛 3 | 🌐 Python | 📅 2020-07-19 - Unsupervised Image to Image Translation with Generative Adversarial Networks
* [DAGGER](https://github.com/zsdonghao/Imitation-Learning-Dagger-Torcs) ⭐ 70 | 🐛 2 | 🌐 Python | 📅 2017-08-10 - For Playing [Gym Torcs](https://github.com/ugo-nama-kun/gym_torcs) ⭐ 426 | 🐛 53 | 🌐 C++ | 📅 2018-03-21
* [Highway Network](https://github.com/fomorians/highway-cnn) ⭐ 56 | 🐛 0 | 🌐 Python | 📅 2016-09-18 - TensorFlow implementation of ["Training Very Deep Networks"](http://arxiv.org/abs/1507.06228) with a [blog post](https://medium.com/jim-fleming/highway-networks-with-tensorflow-1e6dfa667daa#.ndicn1i27)
* [AlexNet3D](https://github.com/denti/AlexNet3D) ⭐ 42 | 🐛 3 | 🌐 Python | 📅 2018-02-09 - An implementations of AlexNet3D. Simple AlexNet model but with 3D convolutional layers (conv3d).
* [TRPO](https://github.com/jjkke88/RL_toolbox) ⭐ 41 | 🐛 1 | 🌐 Python | 📅 2018-01-27 - For Continuous and Discrete Action Space by
* [Sarus TF2 Models](https://github.com/sarus-tech/tf2-published-models) ⭐ 37 | 🐛 1 | 🌐 Python | 📅 2021-09-23 - A long list of recent generative models implemented in clean, easy to reuse, Tensorflow 2 code (Plain Autoencoder, VAE, VQ-VAE, PixelCNN, Gated PixelCNN, PixelCNN++, PixelSNAIL, Conditional Neural Processes).
* [Spatial Transformer Networks](https://github.com/zsdonghao/Spatial-Transformer-Nets) ⭐ 36 | 🐛 3 | 🌐 Python | 📅 2019-06-17 - Learn the Transformation Function
* [VGAN Tensorflow](https://github.com/Singularity42/VGAN-Tensorflow) ⭐ 15 | 🐛 2 | 🌐 Python | 📅 2018-03-20 - Tensorflow implementation for MIT ["Generating Videos with Scene Dynamics"](http://carlvondrick.com/tinyvideo/) by Vondrick et al.
* [Dynamic Capacity Networks](https://github.com/jazzsaxmafia/dcn.tf) ⭐ 9 | 🐛 0 | 🌐 Python | 📅 2016-05-03 - Implementation of ["Dynamic Capacity Networks"](http://arxiv.org/abs/1511.07838)
* [TF-Unet](https://github.com/juniorxsound/TF-Unet) ⭐ 2 | 🐛 1 | 🌐 Jupyter Notebook | 📅 2019-11-09 - General purpose U-Network implemented in Keras for image segmentation
* [Holographic Embeddings for Graph Completion and Link Prediction](https://github.com/laxatives/TensorFlow-TransX) ⭐ 0 | 🐛 0 | 📅 2017-10-24 - Implementation of [Holographic Embeddings of Knowledge Graphs](http://arxiv.org/abs/1510.04935)
...
* [Magenta](https://github.com/tensorflow/magenta) ⚠️ Archived - Research project to advance the state of the art in machine intelligence for music and art generation
* [YOLO TensorFlow](https://github.com/gliese581gg/YOLO_tensorflow) ⭐ 1,708 | 🐛 38 | 🌐 Python | 📅 2019-01-05 - Implementation of 'YOLO : Real-Time Object Detection'
* [android-yolo](https://github.com/natanielruiz/android-yolo) ⭐ 691 | 🐛 13 | 🌐 C++ | 📅 2022-10-15 - Real-time object detection on Android using the YOLO network, powered by TensorFlow.

<a name="libraries" />

## Libraries

* [TensorFlow-Slim](https://github.com/tensorflow/models/tree/master/inception/inception/slim) ⭐ 77,653 | 🐛 1,271 | 🌐 Python | 📅 2026-09-16 - High-level library for defining models
* [SyntaxNet: Neural Models of Syntax](https://github.com/tensorflow/models/tree/master/syntaxnet) ⭐ 77,653 | 🐛 1,271 | 🌐 Python | 📅 2026-09-16 - A TensorFlow implementation of the models described in [Globally Normalized Transition-Based Neural Networks, Andor et al. (2016)](http://arxiv.org/pdf/1603.06042.pdf)
* [Sonnet](https://github.com/deepmind/sonnet) ⭐ 9,971 | 🐛 44 | 🌐 Python | 📅 2026-07-07 - Sonnet is DeepMind's library built on top of TensorFlow for building complex neural networks.
* [tflearn](https://github.com/tflearn/tflearn) ⭐ 9,575 | 🐛 579 | 🌐 Python | 📅 2024-05-06 - Deep learning library featuring a higher-level API
* [TensorLayer](https://github.com/tensorlayer/tensorlayer) ⭐ 7,379 | 🐛 36 | 🌐 Python | 📅 2023-02-18 - Deep learning and reinforcement learning library for researchers and engineers
...
* [TensorForce](https://github.com/reinforceio/tensorforce) ⭐ 3,305 | 🐛 45 | 🌐 Python | 📅 2026-09-02 - TensorForce: A TensorFlow library for applied reinforcement learning
* [TensorFlow Estimators](https://www.tensorflow.org/guide/estimators) - high-level TensorFlow API that greatly simplifies machine learning programming (originally [tensorflow/skflow](https://github.com/tensorflow/skflow) ⚠️ Archived)
* [StellarGraph](https://github.com/stellargraph/stellargraph) ⭐ 3,058 | 🐛 326 | 🌐 Python | 📅 2024-04-10 - Machine Learning on Graphs, a Python library for machine learning on graph-structured (network-structured) data.
* [caffe-tensorflow](https://github.com/ethereon/caffe-tensorflow) ⭐ 2,785 | 🐛 120 | 🌐 Python | 📅 2019-07-18 - Convert Caffe models to TensorFlow format
* [pytorch2keras](https://github.com/nerox8664/pytorch2keras) ⭐ 861 | 🐛 62 | 🌐 Python | 📅 2022-12-08 - Convert PyTorch models to Keras (with TensorFlow backend) format
...
* [TensorLayerX](https://github.com/tensorlayer/TensorLayerX) ⭐ 531 | 🐛 15 | 🌐 Python | 📅 2026-01-23 - TensorLayerX: A Unified Deep Learning Framework for All Hardwares, Backends and OS, including TensorFlow.
* [Lattice](https://github.com/tensorflow/lattice) ⚠️ Archived - Implementation of Monotonic Calibrated Interpolated Look-Up Tables in TensorFlow
* [Txeo](https://github.com/rdabra/txeo) ⭐ 54 | 🐛 8 | 🌐 C++ | 📅 2025-05-08 - A modern C++ wrapper for TensorFlow.
* [NNFlow](https://github.com/welschma/NNFlow) ⭐ 7 | 🐛 0 | 🌐 Python | 📅 2021-03-24 - Simple framework allowing to read-in ROOT NTuples by converting them to a Numpy array and then use them in Google Tensorflow.
* [DeepBay](https://github.com/ElPapi42/DeepBay) ⭐ 4 | 🐛 0 | 🌐 Python | 📅 2019-12-22 - High-Level Keras Complement for implement common architectures stacks, served as easy to use plug-n-play modules
* [tf-encrypted](https://github.com/mortendahl/tf-encrypted) ⭐ 3 | 🐛 0 | 📅 2022-06-09 - Layer on top of TensorFlow for doing machine learning on encrypted data
* [gluon2keras](https://github.com/stjordanis/gluon2keras) ⭐ 0 | 🐛 0 | 📅 2018-12-23 - Convert Gluon models to Keras (with TensorFlow backend) format
...
* [Speedster](https://github.com/nebuly-ai/nebullvm/tree/main/apps/accelerate/speedster) ⭐ 8,328 | 🐛 109 | 🌐 Python | 📅 2024-07-22 - Automatically apply SOTA optimization techniques to achieve the maximum inference speed-up on your hardware.
* [ML Workspace](https://github.com/ml-tooling/ml-workspace) ⭐ 3,546 | 🐛 0 | 🌐 Jupyter Notebook | 📅 2024-07-26 - All-in-one web IDE for machine learning and data science. Combines Tensorflow, Jupyter, VS Code, Tensorboard, and many other tools/libraries into one Docker image.
...
* [Diving into Machine Learning through TensorFlow](https://youtu.be/GZBIPwdGtkk?list=PLBkISg6QfSX9HL6us70IBs9slFciFFa4W) - Pycon 2016 Portland Oregon, [Slide](https://storage.googleapis.com/amy-jo/talks/tf-workshop.pdf) & [Code](https://github.com/amygdala/tensorflow-workshop) ⭐ 629 | 🐛 10 | 🌐 Jupyter Notebook | 📅 2018-08-16 by Julia Ferraioli, Amy Unruh, Eli Bixby
...
* [Globally Normalized Transition-Based Neural Networks](http://arxiv.org/abs/1603.06042) - This paper describes the models behind [SyntaxNet](https://github.com/tensorflow/models/tree/master/syntaxnet) ⭐ 77,653 | 🐛 1,271 | 🌐 Python | 📅 2026-09-16.
...
* [Probabilistic Programming and Bayesian Methods for Hackers](https://github.com/CamDavidsonPilon/Probabilistic-Programming-and-Bayesian-Methods-for-Hackers) ⭐ 28,192 | 🐛 203 | 🌐 Jupyter Notebook | 📅 2024-06-25 - by Cameron Davidson-Pilon. Introduction to Bayesian methods and probabilistic graphical models using tensorflow-probability (and, alternatively PyMC2/3).
...
More info on the [guidelines](https://github.com/jtoy/awesome-tensorflow/blob/master/contributing.md) ⭐ 17,551 | 🐛 34 | 📅 2026-02-08

<a name="credits" />

## Credits

* Some of the python libraries were cut-and-pasted from [vinta](https://github.com/vinta/awesome-python) ⭐ 321,757 | 🐛 26 | 🌐 Python | 📅 2026-09-18
